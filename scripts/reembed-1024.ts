/**
 * One-shot migration: re-embed all dim_textbooks_vector chunks
 * using gemini-embedding-2 at 1024D (MRL truncation).
 *
 * Usage: npx tsx scripts/reembed-1024.ts
...
async function main() {
  console.log('🚀 Re-embed migration: gemini-embedding-2 → 1024D (MRL)\n');
